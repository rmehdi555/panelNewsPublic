  ...
  <div class="table-responsive">
    <table class="table table-striped table-sm">
      ...
      @foreach($tickets as  $ticket)
        <tr>
          {{--{{dd($ticket->hasLevelTicket($ticket->level_id)->name )}}--}}
          ...
          <td>
            <a class="btn btn-sm btn-info" href="{{ route("users.userticket.answer",$ticket->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
