                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"> ویرایش کاربر   ___ {{$user->username}}</h3>
                            ...
                            <div class="card-body table-responsive p-0">
                                ...
                                <option value="{{$role->id}}" {{in_array(trim($role->id),$user->roles->pluck('id')->toArray())?'selected':''}}>{{$role->name}} - {{$role->label}}</option>
                                @endforeach
                                </select>
                                </div>
                                </div>
