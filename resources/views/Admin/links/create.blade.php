          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">ایجاد لینک</h3>
                ...
                <form method="POST" action="{{ route('links.store') }}" enctype="multipart/form-data">
                  ...
                  <div class="box box-info">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="destlink" type="text" class="form-control{{ $errors->has('destlink') ? ' is-invalid' : '' }}" name="destlink"  autofocus></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title"  autofocus></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="level_id" class="col-sm-4 col-form-label text-md-center">لینک</label>
                      <div class="col-md-6">
                        <textarea id="link" type="text" class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" name="link"  autofocus></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="level_id" class="col-sm-4 col-form-label text-md-center">مسیر عنوان درون حلقه</label>
                      <div class="col-md-6">
                        <textarea id="ftitlexpath" type="text" class="form-control{{ $errors->has('ftitlexpath') ? ' is-invalid' : '' }}" name="ftitlexpath"  autofocus></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="fabsxpath" type="text" class="form-control{{ $errors->has('fabsxpath') ? ' is-invalid' : '' }}" name="fabsxpath"  autofocus></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="fcontxpath" type="text" class="form-control{{ $errors->has('fcontxpath') ? ' is-invalid' : '' }}" name="fcontxpath"  autofocus></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="fcontxpath" type="text" class="form-control{{ $errors->has('fimgxpath') ? ' is-invalid' : '' }}" name="fimgxpath"  autofocus></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="andkeywords" type="text" class="form-control{{ $errors->has('andkeywords') ? ' is-invalid' : '' }}" name="andkeywords"  autofocus></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="level_id" class="col-sm-4 col-form-label text-md-center"> کلمات کلیدی هر یک از (or)</label>
                      <div class="col-md-6">
                        <textarea id="orkeywords" type="text" class="form-control{{ $errors->has('orkeywords') ? ' is-invalid' : '' }}" name="orkeywords"  autofocus></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="level_id" class="col-sm-4 col-form-label text-md-center">کلمات کلیدی هیچ یک از (not)</label>
                      <div class="col-md-6">
                        <textarea id="notkeywords" type="text" class="form-control{{ $errors->has('notkeywords') ? ' is-invalid' : '' }}" name="notkeywords"  autofocus></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="titlexpath" type="text" class="form-control{{ $errors->has('titlexpath') ? ' is-invalid' : '' }}" name="titlexpath"  autofocus></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="level_id" class="col-sm-4 col-form-label text-md-center">مسیر چکیده محتوا</label>
                      <div class="col-md-6">
                        <textarea id="absxpath" type="text" class="form-control{{ $errors->has('absxpath') ? ' is-invalid' : '' }}" name="absxpath"  autofocus></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="contxpath" type="text" class="form-control{{ $errors->has('contxpath') ? ' is-invalid' : '' }}" name="contxpath"  autofocus></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="level_id" class="col-sm-4 col-form-label text-md-center"> مسیر برچسب های محتوا</label>
                      <div class="col-md-6">
                        <textarea id="tgxpath" type="text" class="form-control{{ $errors->has('tgxpath') ? ' is-invalid' : '' }}" name="tgxpath"  autofocus></textarea>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <textarea id="imgxpath" type="text" class="form-control{{ $errors->has('imgxpath') ? ' is-invalid' : '' }}" name="imgxpath"  autofocus></textarea>
                      </div>
                    </div>
                      <div class="form-group row">
