...
@section('content')
  ...
  <div class="card">
    <div class="card-header">ایجادstatusticket  </div>

    <div class="card-body">
      <form method="POST" action="{{ route('statustickets.store')}}" method="post" enctype="multipart/form-data">
        @csrf


        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">ایجاد statusticket </h3>
          </div>
