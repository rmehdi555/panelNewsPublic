...
@section('content')
  ...
  <div class="card">
    <div class="card-header">ایجادlevelticket  </div>

    <div class="card-body">
      <form method="POST" action="{{ route('leveltickets.store')}}" method="post" enctype="multipart/form-data">
        @csrf


        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">ایجاد levelticket </h3>
          </div>
